...
![발표开场: 코드 이해의 중요성](/images/understanding-code-ai-era/frame_50.jpg){: .shadow }
...
![Understand to Verify vs Participate](/images/understanding-code-ai-era/frame_120.jpg){: .shadow }

### 진짜 이유: "Understand to Participate"

Geoffrey가 강조하는 핵심:

> "코드를 리뷰하고 이해하는 과정에서 **당신 자신이 변화**한다. 그 이해가 다음 루프의 기반이 된다."

풍부한 개념 구조가 머릿속에 있으면, 매번 에이전트에게 물어보지 않고도 유창하게 사고하고 창발적 아이디어 도약을 할 수 있다. 이것이야말로 **인간의 역할**이다.

### Cognitive Debt (인지 부채)

기술 부채(technical debt)의 사촌 개념. 학자 Margaret Mead가 대중화했고 Simon Willison도 블로그로 다뤘다.
...
![Cognitive Debt](/images/understanding-code-ai-era/frame_210.jpg){: .shadow }
...
![세 가지 기법 개요](/images/understanding-code-ai-era/frame_300.jpg){: .shadow }
...
- 게임 엔진이 뭘 쓰는지, 좌표계가 어떻게 되는지, 하위 시스템은 뭔지
- 이미 알면 스킵 가능 (개인화)
...
> "이 커밋의 목표는 2D 드로잉 트릭만으로 정원을 3D처럼 보이게 하는 것"

좋은 수학 선생님이 하는 방식 — essence를 먼저, detail은 나중에.
...
![코드 설명서 원칙: Background, Intuition, Interactive](/images/understanding-code-ai-era/frame_330.jpg){: .shadow }
...
- 책을 읽고도 이해하지 못했는지 알기 어렵다
- Matushak은 에세이 안에 **spaced repetition 퀴즈**를 넣어 해결
...
![A quiz is a speed regulator](/images/understanding-code-ai-era/frame_570.jpg){: .shadow }
...
![Microworlds 기법 소개](/images/understanding-code-ai-era/frame_690.jpg){: .shadow }
...
- 모든 state를 매 스텝마다 보여줌
- 버그를 수정할 뿐 아니라 기계 자체에 대한 **감각(peripheral vision)** 획득
- 에이전트에게 버그 수정을 맡기면 얻을 수 없는 깊은 이해

![Prolog 인터프리터 마이크로월드](/images/understanding-code-ai-era/frame_840.jpg){: .shadow }

### 사례 2: 웹사이트 마이그레이션

개인 웹사이트를 한 프레임워크에서 다른 프레임워크로 마이그레이션:

1. 첫 시도: Claude에게 스크립트 작성을 맡김 → 작동하지만 "뭘 하는지 감이 안 옴"
...
![웹사이트 마이그레이션 마이크로월드](/images/understanding-code-ai-era/frame_930.jpg){: .shadow }
...
- 아이디어를 함께 논의하는 강력한 기본 요소(primitive)

> 2026년 7월 기준, Notion에서 Claude와 Cursor를 코딩 에이전트로 직접 사용할 수 있게 됐다.

![공유 공간: 팀과 함께 이해하기](/images/understanding-code-ai-era/frame_990.jpg){: .shadow }
...
![Alan Kay의 Dynabook 비전](/images/understanding-code-ai-era/frame_1140.jpg){: .shadow }
